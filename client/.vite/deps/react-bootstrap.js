...
import {
  ...
  forEach,
  map
} from "./chunk-3T7RRE4A.js";
import {
  require_warning
} from "./chunk-NCIJFY5W.js";
import {
  Row_default
} from "./chunk-7FAJXOAB.js";
import {
  Col_default,
  useCol
} from "./chunk-2R2Y3V6V.js";
import {
  DEFAULT_BREAKPOINTS,
...
var InputGroupText = React62.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime59.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime59.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime59.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime59.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
});
var InputGroup = React63.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
...
var TabContext = React64.createContext(null);
...
var NavItem = React65.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
  ...
  return (0, import_jsx_runtime60.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React66.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  return (0, import_jsx_runtime61.jsx)(SelectableContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime61.jsx)(NavContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime61.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var ListGroupItem = React67.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React68.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime63.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
function NoopTransition({
  ...
  const child = (0, import_react50.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react51.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime64.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
    return (0, import_jsx_runtime64.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime64.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react52.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime65.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime65.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime65.jsx)(import_jsx_runtime66.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime67.jsxs)(import_jsx_runtime66.Fragment, {
...
var AbstractModalHeader = React75.forwardRef(({
  ...
  const context6 = (0, import_react53.useContext)(ModalContext_default);
...
var Modal2 = React78.forwardRef(({
  ...
  const renderBackdrop = (0, import_react54.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
...
var Nav2 = React81.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react55.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react55.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React83.forwardRef(({
  ...
  const context6 = (0, import_react56.useContext)(NavbarContext_default);
...
var NavbarToggle = React84.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react57.useContext)(NavbarContext_default) || {};
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react58.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react59.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React89.forwardRef(({
  ...
  const modalManager = (0, import_react60.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react60.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react60.useState)(false);
  ...
  const renderBackdrop = (0, import_react60.useCallback)((backdropProps) => (0, import_jsx_runtime86.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React90.forwardRef((props, ref) => {
  const context6 = (0, import_react61.useContext)(NavbarContext_default);
...
var Navbar = React92.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react62.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react62.useMemo)(() => ({
...
var Overlay = React94.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react64.useState)(!props.show);
...
var Popover = React98.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime96.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime96.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime98.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime98.jsx)("div", {
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react65.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React100.forwardRef(({
  ...
  const popperRef = (0, import_react66.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react66.useState)(null);
  ...
  return (0, import_jsx_runtime100.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react67.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react67.useRef)("");
  ...
  const handleShow = (0, import_react67.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react67.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react67.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react67.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react67.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react67.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react67.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime103.jsxs)(import_jsx_runtime102.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react67.cloneElement)(children, triggerProps), (0, import_jsx_runtime101.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React102.forwardRef(({
  ...
  return (0, import_jsx_runtime104.jsx)("li", {
    ref,
    style: style2,
    ...
    children: (0, import_jsx_runtime105.jsxs)(Component2, {
      className: (0, import_classnames73.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime104.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React102.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime105.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React103.forwardRef(({
  ...
  return (0, import_jsx_runtime106.jsx)("ul", {
    ref,
    ...props,
...
var ProgressBar = React106.forwardRef(({
  ...
  return (0, import_jsx_runtime109.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react68.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Spinner = React108.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React109.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React111.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime115.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime115.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime115.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime115.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContent = React114.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React115.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime119.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime119.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime119.jsx)(Transition, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime119.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React116.forwardRef(({
  ...
  const table = (0, import_jsx_runtime120.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime121.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime121.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime122.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime121.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime121.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime121.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React118.forwardRef((props, ref) => (0, import_jsx_runtime123.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React119.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React120.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime125.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime124.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React121.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React122.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime127.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime127.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime127.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React123.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React124.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime131.jsxs)(import_jsx_runtime130.Fragment, {
    children: [(0, import_jsx_runtime129.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime129.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React125.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime132.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
